  ...
  <div class="col-sm-8 offset-sm-2">
      ...
      <form method="post" action="{{ route('attractions.update', $attraction->id) }}">
            ...
            <div class="form-group">    
                ...
                <input type="text" class="form-control" name="longitude" placeholder="Enter longitude FX 55.12345" value="{{ $attraction->longitude }}">
            </div>
            <div class="form-group">    
                <label for="image">Latitude</label>
                <input type="text" class="form-control" name="latitude" placeholder="Enter latitude FX 10.12345" value="{{ $attraction->latitude }}">
            </div>
